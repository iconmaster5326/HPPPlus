 ...
 * @author iconmaster
 */
public class DuplicateVariableException extends HPPPlusException {
    
    public DuplicateVariableException(SourceRange range,Object thing) {
        super(range,"Duplicate variable name "+thing);
    }
